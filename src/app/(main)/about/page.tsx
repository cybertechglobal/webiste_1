          ...
          <div className="mt-7.5 flex flex-col gap-7.5 min-[1180px]:flex-row lg:mt-4">
            <div className="text-base/7 text-white">
              <p>
                ...
                Consectetur consequat luctus est a sit sapien ultricies quis.
                Ipsum amet urna feugiat aenean. Faucibus ornare porttitor vitae
                vivamus nisi volutpat.
              </p>
              <p className="mt-3">
                Ut ut ornare in mattis. Viverra etiam cursus natoque vivamus
                amet elit sit faucibus euismod. Suspendisse suspendisse mattis
                lorem malesuada egestas in luctus. Purus risus bibendum neque
                turpis pharetra. At aliquet mi et sem pretium vitae odio massa
                vulputate. Ornare sagittis imperdiet vitae dui eget venenatis
                rhoncus. Id amet ut risus leo. Suspendisse arcu nulla neque at.
                Eu sapien pellentesque non ac nulla sed imperdiet vitae dui.
              </p>
            </div>
            <Image
