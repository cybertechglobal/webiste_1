  ...
  return (
    <footer className="w-full relative border-t border-border">
      <div className="max-w-7xl mx-auto pb-4 pt-2 lg:py-2 px-4 lg:px-6 grid gap-2.5 lg:grid-cols-3 justify-items-center lg:justify-items-start items-center">
        <div className="flex gap-x-4 items-center -ml-2.5">
          <ExternalLink href="https://facebook.com/" className="p-2">
            <IconBrandFacebook className="text-primary" aria-hidden />
            <span className="sr-only">Facebook</span>
          </ExternalLink>
          <ExternalLink href="https://instagram.com/" className="p-2">
            <IconBrandInstagram className="text-primary" aria-hidden />
            <span className="sr-only">Instagram</span>
          </ExternalLink>
          <ExternalLink href="https://tiktok.com/" className="p-2">
            <IconBrandTiktok className="text-primary" aria-hidden />
